        ...
        <div class="container d-flex justify-content-between">
          <a href="#" class="navbar-brand d-flex align-items-center">
            ...
            <div class="pull-right">
                ...
                ?>
                <form method="post">
                    <button name="logout" class="btn btn-danger my-2">déconnexion</button>
                </form>
            </div>
        </div>
      </div>
            ...
            <?php
                ...
                if(count(fetchAll($query))>0){
                    ...
                    <h1 class="jumbotron-heading"><?php echo $row['email'] ?></h1>
                      ...
                      <p>
                        <a href="accept.php?id=<?php echo $row['id'] ?>" class="btn btn-primary my-2">Accepter</a>
                        <a href="reject.php?id=<?php echo $row['id'] ?>" class="btn btn-secondary my-2">Rejecter</a>
                      </p>
